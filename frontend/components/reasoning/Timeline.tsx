    ...
    <div className="h-[calc(100vh-250px)] overflow-y-auto pr-2">
      <div className="relative space-y-4">
        ...
        {orderedStages.slice(0, visibleCount).map((stage) => (
          <section
            className="relative ml-10 border border-border bg-muted p-4 motion-safe:animate-[fadeIn_240ms_ease-out]"
            key={stage.id}
          >
            <div className="absolute -left-[31px] top-4 grid h-8 w-8 place-items-center rounded-full border border-primary bg-background text-xs font-semibold text-primary">
              {stage.order}
            </div>
